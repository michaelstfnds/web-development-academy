...
<head>
    ...
    <title>Hotel Stay - Login to your account</title>
...
<body>
    ...
    <main>
        <div class="container">
            <div>
                <h3 class="login-msg">Sign in to your account</h3>
            </div>
            <hr>
            <div class="login-form">
                <form method="POST" action="actions/login.php">
                    ...
                    <button type="button" class="btn btn-info btn-size">Sign in</button>
                </form>
            </div>
        </div>
    </main>
